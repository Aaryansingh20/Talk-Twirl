...
export default function SearchComponent({ onSidebar }: { onSidebar: boolean }) {
  ...
  const SkeletonItem = () => (
    <div className="flex items-center px-4 py-3 animate-pulse">
      <div className="h-12 w-12 rounded-full bg-black mr-3" />
      <div className="flex-1">
        <div className="h-4 bg-black rounded w-1/3 mb-2" />
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        {onSidebar ? <Button variant="ghost" size="icon">
          ...
          <div className="mt-5">
            <Button className="bg-[#2563eb] hover:bg-[#60a8fb] text-white">
              Bother Somebody
            </Button>
          </div>
        }
      ...
      <DialogContent className="w-full max-w-[380px] p-0 bg-black border-[#313D45]">
        <DialogHeader className="p-0">
          ...
          <div className="p-2 bg-black">
            <div className="relative bg-black rounded-lg flex items-center">
              ...
              <input
                ...
                className="w-full bg-transparent border-none text-[#E9EDEF] placeholder:text-[#8696A0]  py-2 text-base"
              />
            </div>
          </div>
